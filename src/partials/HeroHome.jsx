        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p
              ...
              data-aos-delay="200"
            >
              Dzięki setkom starannie wyselekcjonowanych przysłów, podzielonych
              na tematy, w Przysłowioinatorze zawsze znajdziesz idealne
              przysłowie, które urozmaici Twoją komunikację i przyniesie cenne
              mądrości przekazywane od wieków.
            </p>
